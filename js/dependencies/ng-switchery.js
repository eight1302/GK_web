!function() {
	...
	t.loader = "component", t.helper = {}, t.helper.semVerSort = function(t, e) {
		for (var n = t.version.split("."), i = e.version.split("."), o = 0; o < n.length; ++o) {
			...
			var c = n[o].substr(("" + r).length),
				a = i[o].substr(("" + s).length);
			if ("" === c && "" !== a) return 1;
			if ("" !== c && "" === a) return -1;
		...
		var o = /(.*)~(.*)@v?(\d+\.\d+\.\d+[^\/]*)$/,
			r = /(.*)~(.*)/;
		r.test(e) || i(e);
		for (var s = Object.keys(t.modules), c = [], a = [], l = 0; l < s.length; l++) {
			var h = s[l];
		...
		t.bind = function(t, e, i, r) {
			return t[n](o + e, i, r || !1), i
		}, t.unbind = function(t, e, n, r) {
			return t[i](o + e, n, r || !1), n
		}
		...
		n.exports = i, i.prototype.sub = function(t, e, n) {
			...
			return i.selector ? n = s.bind(c, i.selector, l, n) : r.bind(c, l, n), this.sub(l, e, n), n
...
}(), angular.module("NgSwitchery", []).directive("uiSwitch", ["$window", "$timeout", "$log", "$parse", function(t, e, n, i) {
	function o(n, o, r, s) {
		function c() {
			e(function() {
				h && angular.element(h.switcher).remove(), h = new t.Switchery(o[0], a);
				var e = h.element;
				e.checked = n.initValue, h.setPosition(!1), e.addEventListener("change", function(t) {
					n.$apply(function() {
						s.$setViewValue(e.checked)
					})
				})
			}, 0)
		}
